...
function UserUpdatePage() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      navigate('/update-user', {
        state: { toastMessage: message, type: 'error' }
      });
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex items-center justify-center mt-8 p-4">
        ...
        >
          ...
          <AnimatePresence>
            {!firstName && !lastName && (
              <motion.div key="email-input" {...inputVariants} className="mb-4">
                <label
                  className="text-gray-700 dark:text-gray-300 text-sm font-bold mb-2 flex items-center"
                  htmlFor="emailOrName"
                >
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2">
              {roles.map((role) => (
                  ...
                  className={`
                                    cursor-pointer rounded-lg p-2 text-center ${
                                      newRole === role.value
                                        ...
                                        : 'bg-purple-50 dark:bg-gray-700 text-purple-700 dark:text-purple-400  hover:bg-purple-100 dark:hover:bg-gray-600'
                                    }
                ...
                >
                  <div
                    className={`mb-1 ${newRole === role.value ? 'text-white' : role.color}`}
                  >
                    {role.icon}
                  </div>
